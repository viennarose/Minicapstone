<div>
    <div class="card" style="height: 500px; width: 800px; margin-left:70px; margin-top:50px">
                    ...
                    <form action="" wire:submit.prevent='create'>
                        <div class="card-body">
                            ...
                            <div class="from-group">
                                <textarea class="form-control" wire:model="description" id="description" cols="10"
                            ...
                            @if ($image)
                            <img src="{{$image->temporaryUrl()}}" style="width: 100px;height:50px;" alt="">
                            @endif
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="from-group mb-3">
                                ...
                                <textarea type="text" wire:model='edit_description' name="description" id="description"
                                    class="form-contro-lg form-control" cols="5"
                                    rows="3"  placeholder="Service Description"></textarea>
                            </div>
                            <div class="from-group">
                            ...
                            @if ($new_image)
                            <img src="{{$new_image->temporaryUrl()}}" style="width: 100px;height:50px;" alt="">
                            @else
                            <img src="{{ asset('storage') }}/{{$old_image}}" style="width: 100px;height:50px;" alt="">
                            @endif
                            <input type="hidden" wire:model='old_image' name="" id="">
                        </div>
                        <div class="card-footer d-flex float-end ms-3">
