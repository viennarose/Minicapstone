            ...
            <div class="row mx-auto">
                <div class="bg-info mb-3 me-4 d-flex col-md-3" data-aos="fade-right">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="fw-lighter text-break" style="font-size:13px;">Panaytayon</p>
                    </div>
                </div>
                <div class="bg-info mb-3 me-4 d-flex col-md-4" data-aos="zoom-out">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="fw-lighter text-break" style="font-size:13px;">viennapepito01@gmail.com</p>
                    </div>
                </div>
                <div class="bg-info mb-3 d-flex col-md-4" data-aos="fade-left">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="fw-lighter text-break" style="font-size:13px;">0987654321</p>
                    </div>
                </div>
            </div>
