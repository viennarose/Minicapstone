...
class Index extends Component
{
    ...
    public function setAppointment(){
        ...
        $this->validate([
            ...
            'schedule' => ['required', 'date', 'unique:appointments'],
        ]);
    ...
    public function updateAppointment(){
        $this->validate([
            ...
            'services_id' => ['required'],
            'contact' => ['required', 'numeric'],
            'schedule' => ['required', 'string', 'unique:appointments,schedule,'.$this->appointment_id],
    ...
    public function render()
    {
        ...
        return view('livewire.admin.appointments.index', $this->loadAppointments(), ['appointments' => $appointments,'services'=> Service::all()]);
    }
}
